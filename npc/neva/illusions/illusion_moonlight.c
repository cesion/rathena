...
OnInit:
	questinfo( QTYPE_QUEST, QMARK_YELLOW, "!isbegin_quest(7776)  && BaseLevel >= 130 && BaseLevel <= 175" );
	end;
}
...
OnInit:
	questinfo( QTYPE_QUEST, QMARK_YELLOW, "isbegin_quest(7776) == 1 && isbegin_quest(7777) != 1" );
	end;
}
...
OnInit:
	questinfo( QTYPE_QUEST, QMARK_NONE, "!isbegin_quest(7777) && isbegin_quest(7778) == 1" );
	questinfo( QTYPE_QUEST, QMARK_NONE, "!isbegin_quest(7778) && isbegin_quest(7779) == 1" );
	questinfo( QTYPE_QUEST, QMARK_NONE, "!isbegin_quest(7779) && isbegin_quest(7780) == 1" );
	end;
}
...
OnInit:
	questinfo( QTYPE_QUEST, QMARK_NONE, "!isbegin_quest(7780) && isbegin_quest(7781) == 1" );
	end;
}
